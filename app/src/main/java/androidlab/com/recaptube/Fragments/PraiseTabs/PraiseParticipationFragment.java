...
public class PraiseParticipationFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_praise_participation, container, false);

        bundle=new Bundle();
        Text=getArguments().getString("text");
        btn1=(Button)view.findViewById(R.id.participatinginthesession);
        btn2=(Button)view.findViewById(R.id.engaginginthesession);
    ...
    public void onClick(View v) {
        ...
        switch (id)
        {
            case R.id.participatinginthesession:
                ...
                break;
            case R.id.engaginginthesession:
