...
public class EngagementCustomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_engagement_custom, container, false);


        Text=getArguments().getString("text");
        bundle=new Bundle();
        btnDiscussionCustom = (Button) view.findViewById(R.id.btnEngCustom);
