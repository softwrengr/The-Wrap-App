...
public class EngagementDiversionFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_engagement_diversion, container, false);
       ...
       // temp=Text.replace(oldText,newText);
        btn1=(Button)view.findViewById(R.id.humor);
        btn2=(Button)view.findViewById(R.id.astory);
