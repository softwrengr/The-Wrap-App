...
public class PraiseCustomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_praise_custom, container, false);


        Text=getArguments().getString("text");
        bundle=new Bundle();
        btnDiscussionCustom = (Button) view.findViewById(R.id.btnPraiseCustom);
